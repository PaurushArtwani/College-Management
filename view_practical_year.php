                ...
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                                        ...
                                        $query = mysqli_query($con,"select * from master_subject_practical_paper where (class_id='$class_id') && (sem_id = '$sem_id') ");
...
$(document).ready(function(){
  $("#subject_data").change(function(){
      ...
      $.ajax({
    url: "view_practical_session_year.php?subject_data="+item_id,
