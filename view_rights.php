...
$id1=$_GET['id'];
	$selecto7=mysqli_query($con,"select * from `user_management` where `role_id`='$id1'");
   ...
   <div class="portlet box #d6e9c6 " style="width:70%;margin-left:15%;" >
						...
						<div class="portlet-body" >
								 ...
								 <div class="table-scrollable">
                                    ...
                                    <?php
                                    $r1=mysqli_query($con,"select *  FROM `modules` ORDER BY id");		
                                    $i=0;
                                    $main_menu_arr = array();
									...
									<td colspan="3" style="padding:0px;">
										<div id="sub_menu<?php echo $i;?>" class="panel-collapse collapse">
											<table class="table  table-advance table-hover" >
													...
													<?php
													$r=mysqli_query($con,"SELECT * FROM modules where `main_menu`='$main_menu'");		
													$j=0;
...
<script src="assets/js/login_page/jquery-3.3.1.slim.min.js" type="text/javascript"></script>
<script>
