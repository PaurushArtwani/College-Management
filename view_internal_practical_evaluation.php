...
<div class="panel panel-info">
  <div class="panel-heading font-weight-bold">Internal Practical Evaluation <span><a href="" class="pull-right"></a></span> </div>
...
$(document).ready(function(){
  $("#view_u").change(function(){
      ...
      $.ajax({
    url: "view_practical_branch.php?id="+item_id,
