...
<div class="panel panel-info">
  <div class="panel-heading font-weight-bold">Internal Theory Evaluation <span><a href="internal_theory_evealuation.php" class="pull-right btn btn-success btn-sm">Add Internal Theory Evaluation</a></span> </div>
...
$(document).ready(function(){
  $("#view_u").change(function(){
      ...
      $.ajax({
    url: "view_theory_branch.php?id="+item_id,
