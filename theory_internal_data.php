...
?>
  ...
  <table class="table table-hover table-striped" id="table">
    ...
    <tbody>
      <p id="change"></p>
        <input type="button" id="button_click" name="submitting" onclick="CheckValue()" value="Submit" class="btn btn-success btn_click"><br><br>
      <?php
...
//var_dump($query);
      ...
      while ($row_data = mysqli_fetch_array($run_query)) {
       ...
       <td>
        ...
        <input type="number" id="txtFirstNo<?php echo $i;?>" onkeyup="sum()" name="obtained_marks[]" placeholder="Marks Obtained" style="width: 70%;" class="form-control" required="">

      </td>
        <td>
          <input type="number" id="txtSecondNo<?php echo $i;?>"   onkeyup="sum()" name="teacher_ass[]" placeholder="Teachers Assessment" style="width: 70%;" class="form-control" required="">
        </td>

        <td>

          <input type="text" id="txtResult<?php echo $i;?>" name="total_number[]" readonly="" placeholder="Total" style="width: 70%;" class="form-control">
