...
else if ($subject_data == 10 || $subject_data == 30 || $subject_data == 59 || $subject_data == 90){?>
    <a href="french_evaluation_print.php?year_id=<?php echo $year_id;?>" target="_blank" class="btn btn-sm btn-info" ><i class="fa fa-print"></i></a>
<?php
}  
      ...
      while ($row_data = mysqli_fetch_array($run_query)) {
        ...
        ?>
            ...
            theory_subject_id :<?php echo $subject_data;?>
                ...
                swal("Success!", "Internal Practical Number Added!", "success");
